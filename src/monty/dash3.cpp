// FIXME was: builtin.cpp - exceptions and auto-generated built-in tables
...
static auto f_argtest (ArgVec const& args, Value a1, Value a2, Object* a3, int a4, Value a5, char const* a6, char const* a7, Value a8) -> Value {
    ...
    for (int i = 0; i < args.kwNum(); ++i) {
        ...
        switch (k.asQid()) {
            case Q(184,"foo"): foo = v; break;
            case Q(185,"bar"): bar = v; break;
            case Q(186,"baz"): baz = v; break;
...
//CG< type-info
Type    Buffer::info (Q(193,"<buffer>"));
Type   Context::info (Q(194,"<context>"));
Type Exception::info (Q(195,"<exception>"));
Type  Function::info (Q(196,"<function>"));
Type  Iterator::info (Q(197,"<iterator>"));
Type    Lookup::info (Q(198,"<lookup>"));
Type    Method::info (Q(199,"<method>"));
Type    Module::info (Q(7,"<module>"));
Type      None::info (Q(200,"<none>"));
Type  Stacklet::info (Q(201,"<stacklet>"));
