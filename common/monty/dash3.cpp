...
//CG< type-info
Type    Buffer::info (Q(196,"<buffer>"));
Type   Context::info (Q(197,"<context>"));
Type Exception::info (Q(198,"<exception>"));
Type  Function::info (Q(199,"<function>"));
Type  Iterator::info (Q(200,"<iterator>"));
Type    Lookup::info (Q(201,"<lookup>"));
Type    Method::info (Q(202,"<method>"));
Type    Module::info (Q(7,"<module>"));
Type      None::info (Q(203,"<none>"));
Type  Stacklet::info (Q(204,"<stacklet>"));
