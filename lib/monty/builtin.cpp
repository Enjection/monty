...
static auto f_argtest (ArgVec const& args, Value a1, Value a2, Object* a3, int a4, Value a5, char const* a6, char const* a7, Value a8) -> Value {
    ...
    for (int i = 0; i < args.kwNum(); ++i) {
        ...
        switch (k.asQid()) {
            case Q(171,"foo"): foo = v; break;
            case Q(172,"bar"): bar = v; break;
            case Q(173,"baz"): baz = v; break;
...
//CG< wrappers *
static Function const fo_abs ("v", (Function::Prim) f_abs);
static Function const fo_argtest ("vvoi?vssv*", (Function::Prim) f_argtest);
static Function const fo_dir ("v", (Function::Prim) f_dir);
static Function const fo_hash ("v", (Function::Prim) f_hash);
static Function const fo_id ("v", (Function::Prim) f_id);
static Function const fo_iter ("o", (Function::Prim) f_iter);
static Function const fo_len ("v", (Function::Prim) f_len);
static Function const fo_next ("v", (Function::Prim) f_next);
static Function const fo_print ("*", (Function::Prim) f_print);
...
static Lookup::Item const exception_map [] = {
    { Q(175,"trace"), mo_exception_trace },
};
...
static Lookup::Item const builtinsMap [] = {
    ...
    { Q(176,"class"), Class::info },
    { Q(75,"dict"),   Dict::info },
    { Q(177,"event"), Event::info },
    { Q(94,"int"),    Int::info },
    { Q(108,"list"),  List::info },
    { Q(124,"range"), Range::info },
    { Q(140,"set"),   Set::info },
    { Q(178,"slice"), Slice::info },
    { Q(151,"str"),   Str::info },
...
//CG< type-info
Type    Buffer::info (Q(180,"<buffer>"));
Type Exception::info (Q(181,"<exception>"));
Type  Function::info (Q(182,"<function>"));
Type  Iterator::info (Q(183,"<iterator>"));
Type    Lookup::info (Q(184,"<lookup>"));
Type    Method::info (Q(185,"<method>"));
Type    Module::info (Q(7,"<module>"));
Type      None::info (Q(186,"<none>"));
Type  Stacklet::info (Q(187,"<stacklet>"));

Type      Bool::info (Q(62,"bool"),    &Bool::attrs,  Bool::create);
Type     Bytes::info (Q(66,"bytes"),  &Bytes::attrs, Bytes::create);
Type     Class::info (Q(176,"class"), &Class::attrs, Class::create);
Type      Dict::info (Q(75,"dict"),    &Dict::attrs,  Dict::create);
Type     Event::info (Q(177,"event"), &Event::attrs, Event::create);
...
Type     Slice::info (Q(178,"slice"), &Slice::attrs, Slice::create);
